...
public class EditAnswerServlet extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        AnswerInfo answerInfo=list.get(currentAnswerIndex-1);
...
//        answerInfo.setQuestionId(question);
        ...
        if(currentAnswerIndex>numberOfAnswers){
            ...
            response.sendRedirect(request.getContextPath()+"/website/HTML/edit_answers.jsp?questionId=" + questionId + "&numberOfAnswers="+numberOfAnswers+"&currentAnswerIndex="+currentAnswerIndex+"&test_name="+testName+"&email="+email);
        }
    }
}
